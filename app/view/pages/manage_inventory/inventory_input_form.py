...
class InventoryInputForm(CTkToplevel):
    def __init__(self, callback: Callable, master=None, *args, **kwargs) -> None:
        ...
        CTkLabel(
            master=self, text="افزودن ماده به انبار", font=("B Koodak Bold", 25)
        ...
        self.__ingredient_combobox_var = StringVar(
            value='' if len(self.__ingredient_names) == 0 else self.__ingredient_names[0])
        ...
        self.__selected_entrance_date = datetime.date.today()
        ...
        self.__selected_manufacture_date = datetime.date.today()
        ...
        self.__selected_expire_date = datetime.date.today()
    ...
    def __submit(self) -> None:
        ...
        self.__callback(ingredient_id, quantity, price, entrance_date, manufacture_date,
                        expire_date)
