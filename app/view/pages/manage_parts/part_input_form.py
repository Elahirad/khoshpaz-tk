...
class PartInputForm(CTkToplevel):
    ...
    def __submit(self) -> None:
        ...
        self.__callback(name, {transform(ing): amount for ing, amount in self.__selected_ingredients.items()})
